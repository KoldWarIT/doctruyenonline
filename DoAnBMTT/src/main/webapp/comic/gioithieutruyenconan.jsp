				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/conan.png" alt="Bootstrap">
						</div>
						...
						<div class="info-container">
							...
							<p>
								<strong>Tác giả:</strong> Gosho Aoyama
							</p>
							<p>
								<strong>Tình trạng:</strong> Đang cập nhật
							</p>
							<p>
								<strong>Thể loại:</strong> Trinh thám - Hành động
							</p>
							<p>
								<strong>Lượt xem:</strong> 85670
							</p>
							<p>
								<strong>Lượt thích:</strong> 1294
							</p>
							<p>
								<strong>Mô tả:</strong> "Thám tử lừng danh Conan" là một bộ
								truyện trinh thám xoay quanh nhân vật chính Shinichi Kudo, một
								thám tử trung học tài năng. Trong một lần điều tra, cậu bị tổ
								chức Áo đen ép uống chất độc Apotoxin-4869, khiến cậu teo nhỏ
								thành một cậu bé tiểu học. Dưới danh tính mới là Conan Edogawa,
								Shinichi sống cùng cô bạn thân Ran Mori và cha của cô, thám tử
								Kogoro Mori. Dù bị thu nhỏ, Conan vẫn tiếp tục điều tra các vụ
								án, sử dụng trí tuệ sắc bén của mình để phá án và tìm cách lật
								đổ tổ chức Áo đen. Bên cạnh những vụ án hấp dẫn, Conan còn phải
								đối mặt với việc giấu kín thân phận thật của mình để bảo vệ
								những người xung quanh và tìm cách trở lại hình dạng ban đầu.
								Truyện không chỉ tập trung vào các tình huống phá án đầy kịch
								tính, mà còn xoay quanh mối quan hệ phức tạp giữa các nhân vật,
								cùng những bí ẩn xoay quanh tổ chức Áo đen.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/conan/doctruyenconan.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/conan/doctruyenconan.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
						...
						<div class="list-group">
							...
							<div class="row">
								...
								<div class="col-10">
									...
									<div>
										<a href="#" class="list-group-item list-group-item-action"
											style="font-size: small;">Fairy tail<br />Chapter 162
										</a>
									</div>
								</div>
							</div>
						...
						<div class="list-group">
							...
							<div class="row">
								...
								<div class="col-10">
									...
									<div>
										<a href="#" class="list-group-item list-group-item-action"
											style="font-size: small;">Top manga được yêu thích nhất
											thập kỉ qua </a>
									</div>
								</div>
							</div>
