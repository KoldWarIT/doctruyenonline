...
<body>
		...
		<div class="box">
			<div>
				<h1 class="detail-title txt-primary">
					<a href="#" style="color: white">Thám Tử Lừng Danh Conan</a>
				</h1>
			</div>
	...
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/1.jpg" alt="Bootstrap"></a>
	</div>

	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/2.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/3.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/4.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/5.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/6.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/7.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/8.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/9.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/10.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/11.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/12.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/13.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/14.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/15.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/16.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/17.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/18.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/19.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/20.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/21.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/22.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/23.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/24.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/25.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/26.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/27.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/28.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/29.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/30.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/31.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/32.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/33.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/34.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docconan/chapter1/35.jpg" alt="Bootstrap"></a>
	</div>
