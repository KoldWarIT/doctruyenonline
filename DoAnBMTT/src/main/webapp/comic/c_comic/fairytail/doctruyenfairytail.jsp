...
<%
		...
		<div class="box">
			<div>
				<h1 class="detail-title txt-primary">
					<a href="#" style="color: white">Fairy Tail</a>
				</h1>
			</div>
	...
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/1.jpg" alt="Bootstrap"></a>
	</div>

	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/2.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/3.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/4.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/5.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/6.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/7.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/8.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/9.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/10.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/11.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/12.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/13.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/14.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/15.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/16.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/17.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/18.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/19.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/20.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/21.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docfairytail/chapter1/22.jpg" alt="Bootstrap"></a>
	</div>
