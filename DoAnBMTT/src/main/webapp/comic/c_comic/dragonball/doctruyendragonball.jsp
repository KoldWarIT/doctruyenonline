...
<%
		...
		<div class="box">
			<div>
				<h1 class="detail-title txt-primary">
					<a href="#" style="color: white">Dragon Ball</a>
				</h1>
			</div>
	...
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/1.jpg" alt="Bootstrap"></a>
	</div>

	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/2.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/3.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/4.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/5.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/6.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/7.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/8.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/9.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/10.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/11.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/12.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/13.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/14.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/15.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/16.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/17.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/18.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/19.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/20.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/21.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/22.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/23.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/24.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/25.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/26.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/27.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/28.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/29.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/30.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/31.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/32.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/33.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/34.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/35.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/36.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdragonball/chapter1/37.jpg" alt="Bootstrap"></a>
	</div>
