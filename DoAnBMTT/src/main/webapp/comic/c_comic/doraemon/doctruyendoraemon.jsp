...
<%
		...
		<div class="box">
			<div>
				<h1 class="detail-title txt-primary">
					<a href="#" style="color: white">Doraemon</a>
				</h1>
			</div>
	...
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/1.jpg" alt="Bootstrap"></a>
	</div>

	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/2.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/3.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/4.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/5.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/6.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/7.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/8.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/9.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/10.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/11.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/12.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/13.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/14.jpg" alt="Bootstrap"></a>
	</div>
	
	<div class="d-flex justify-content-center mt-3">
		<a><img class="img-fluid" src="docdoraemon/chapter1/15.jpg" alt="Bootstrap"></a>
	</div>
