				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/fairytail.png" alt="Bootstrap">
						</div>

						<!-- Thông tin truyện -->
						<div class="info-container">
							<h2>
								<strong>Fairy Tail: 100 Years Quest</strong>
							</h2>
							<p>
								<strong>Tác giả:</strong> Mashima Hiro
							</p>
							<p>
							...
							<p>
								<strong>Lượt xem:</strong> 80804
							</p>
							<p>
								<strong>Lượt thích:</strong> 1853
							</p>
							<p>
								<strong>Mô tả:</strong> Tuyện tiếp nối chap 545 của Fairy Tail,
								khi nhóm Natsu đi làm nhiệm vụ trăm năm.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/fairytail/doctruyenfairytail.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/fairytail/doctruyenfairytail.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
