				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/naruto.png" alt="Bootstrap">
						</div>
						...
						<div class="info-container">
							...
							<p>
								<strong>Tác giả:</strong> Kishimoto Masashi
							</p>
							<p>
								<strong>Tình trạng:</strong> Đang cập nhật
							</p>
							<p>
								<strong>Thể loại:</strong> Hành động - Viễn tưởng
							</p>
							<p>
								<strong>Lượt xem:</strong> 73492
							</p>
							<p>
								<strong>Lượt thích:</strong> 9732
							</p>
							<p>
								<strong>Mô tả:</strong>Bối cảnh Naruto xảy ra vào mười hai năm
								trước khi câu chuyện chính thức bắt đầu, một con hồ ly chín đuôi
								đã tấn công Konohagakure. Nó là một con quái vật có sức mạnh
								khủng khiếp, chỉ một cái vẫy từ một trong chín cái đuôi của nó
								có thể tạo ra những cơn sóng thần và san bằng nhiều ngọn núi. Nó
								gây ra sự hỗn loạn và giết chết rất nhiều người cho đến khi
								người đứng đầu làng Lá – Hokage đệ tứ – đã đánh bại nó bằng cách
								đổi lấy mạng sống của mình để phong ấn nó vào trong người một
								đứa trẻ mới sinh. Đứa trẻ đó tên là Uzumaki Naruto. Bộ truyện kể
								về cuộc hành trình đầy gian khổ với vô vàn khó khăn, thử thách
								của Naruto từ khi còn là một cậu bé tới khi trở thành một trong
								những nhẫn giả vĩ đại nhất. Không chỉ mô tả về một thế giới nhẫn
								giả huyền bí, Naruto còn mang trong nó nhiều ý nghĩa nhân sinh
								sâu sắc về tình bạn, tình đồng đội, tình yêu, ước mơ và hi vọng.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/naruto/doctruyennaruto.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/naruto/doctruyennaruto.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
