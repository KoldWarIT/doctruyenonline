				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/doraemon.png" alt="Bootstrap">
						</div>
						...
						<div class="info-container">
							...
							<p>
								<strong>Tác giả:</strong> Fujiko F. Fujio
							</p>
							<p>
								<strong>Tình trạng:</strong> Đang cập nhật
							</p>
							<p>
								<strong>Thể loại:</strong> Hài hước - Viễn tưởng
							</p>
							<p>
								<strong>Lượt xem:</strong> 110104
							</p>
							<p>
								<strong>Lượt thích:</strong> 1101
							</p>
							<p>
								<strong>Mô tả:</strong> "Doraemon" là một bộ truyện tranh nổi
								tiếng xoay quanh chú mèo máy đến từ tương lai tên là Doraemon.
								Cậu được gửi từ thế kỷ 22 để giúp đỡ Nobita, một cậu bé hậu đậu
								và kém may mắn. Doraemon sở hữu một chiếc túi thần kỳ có thể lấy
								ra vô số bảo bối công nghệ cao, giúp Nobita vượt qua những rắc
								rối trong cuộc sống. Câu chuyện thường diễn ra với việc Nobita
								gặp rắc rối ở trường học, với bạn bè, hoặc gia đình, và nhờ
								Doraemon giúp đỡ bằng các bảo bối. Tuy nhiên, việc sử dụng bảo
								bối thường dẫn đến những tình huống hài hước, bất ngờ và đôi khi
								khiến mọi thứ trở nên tồi tệ hơn. Bên cạnh đó, truyện cũng khắc
								họa những tình bạn thân thiết giữa Nobita và các nhân vật khác
								như Shizuka, Suneo, và Jaian. Qua mỗi tập, bộ truyện gửi gắm
								nhiều thông điệp ý nghĩa về tình bạn, sự sáng tạo, và bài học
								cuộc sống, đồng thời đem lại tiếng cười với các tình huống vui
								nhộn và lôi cuốn.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/doraemon/doctruyendoraemon.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/doraemon/doctruyendoraemon.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
