				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/dragonball.png" alt="Bootstrap">
						</div>
						...
						<div class="info-container">
							...
							<p>
								<strong>Tác giả:</strong> Akira Toriyama
							</p>
							<p>
							...
							<p>
								<strong>Lượt xem:</strong> 251204
							</p>
							<p>
								<strong>Lượt thích:</strong> 8734
							</p>
							<p>
								<strong>Mô tả:</strong> "Dragon Ball" xoay quanh hành trình của
								Son Goku, một cậu bé có sức mạnh phi thường, và cuộc tìm kiếm 7
								viên ngọc rồng có thể triệu hồi Rồng Thần ban điều ước. Goku gặp
								nhiều bạn bè như Bulma, Krillin, và đối thủ như Piccolo, Vegeta.
								Cậu không ngừng rèn luyện để bảo vệ Trái Đất khỏi các kẻ thù
								nguy hiểm như Frieza, Cell, và Majin Buu. Bộ truyện nổi bật với
								những trận chiến hoành tráng, hài hước và tình bạn, đồng thời
								truyền tải thông điệp về lòng dũng cảm và sự vươn lên không
								ngừng.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/dragonball/doctruyendragonball.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/dragonball/doctruyendragonball.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
