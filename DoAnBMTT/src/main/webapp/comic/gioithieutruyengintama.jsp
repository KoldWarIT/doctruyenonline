				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/gintama.png" alt="Bootstrap">
						</div>
						...
						<div class="info-container">
							...
							<p>
								<strong>Tác giả:</strong> Hideaki Sorachi
							</p>
							<p>
								<strong>Tình trạng:</strong> Đang cập nhật
							</p>
							<p>
								<strong>Thể loại:</strong> Hành động - Hài hước - Viễn tưởng
							</p>
							<p>
								<strong>Lượt xem:</strong> 45782
							</p>
							<p>
								<strong>Lượt thích:</strong> 1902
							</p>
							<p>
								<strong>Mô tả:</strong> Gintama là câu chuyện xoay xung quanh
								cuộc sống hằng ngày của 3 nhân vật chính: Sakata Gintoki, một
								Samurai hết thời, bị bệnh tiểu đường nặng; Shinpachi Shimura, kẻ
								kế thừa của một võ đường xập xệ do chẳng còn ai đến luyện võ
								trong thời đại này và Kagura, một Amanto với sức mạnh phi
								thường, tham ăn trong thân hình nhỏ bé của 1 cô bé 14 tuổi. Cả 3
								phải làm đủ mọi việc (hầu hết là phá hoại chứ chẳng làm gì
								nghiêm túc) để trả tiền nhà hằng tháng. Gintama là bộ truyện hài
								hước vô cùng độc đáo. Gintama xây dựng lên một thế giới vừa hiện
								đại, lại vừa cổ xưa, rất phù hợp với phong cách của truyện. Bạn
								sẽ bắt gặp trong Gintama từ nhóm Shinsengumi nổi tiếng với các
								đội trưởng tính nết biến thái, các Ninja kỳ quái, cho tới đủ
								kiểu người hành tinh lạ với khả năng dị hợm. Gintama có cách pha
								trò đầy tính hiện đại và bất ngờ dựa trên nhãn quan độc đáo của
								tác giả, mang trong mình những vấn đề rất thời sự và nóng hổi dù
								có một phần bối cảnh vào thời Mạc Phủ. Hãy đọc và cười nghiêng
								ngả cùng Gintama.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg" href="c_comic/gintama/doctruyengintama.jsp">Đọc
									từ đầu</a>
								<a type="button" class="btn btn-primary btn-lg mx-2" href="c_comic/gintama/doctruyengintama.jsp">Đọc
									mới nhất</a>
							</div>
						</div>
					</div>
						...
						<div class="list-group">
							...
							<div class="row">
								...
								<div class="col-10">
									...
									<div>
										<a href="#" class="list-group-item list-group-item-action"
											style="font-size: small;">Fairy tail: Years Quest<br />Chapter
											162
										</a>
									</div>
								</div>
