				...
				<div class="col-8">
					<div class="container content-container">
						...
						<div class="image-container">
							<img src="../img/shin.png" alt="Bootstrap">
						</div>

						<!-- Thông tin truyện -->
						<div class="info-container">
							<h2>
								<strong>Crayon Shin-chan</strong>
							</h2>
							<p>
								<strong>Tác giả:</strong> Usui Yoshito
							</p>
							<p>
								<strong>Tình trạng:</strong> Đang cập nhật
							</p>
							<p>
								<strong>Thể loại:</strong> Hài hước
							</p>
							<p>
								<strong>Lượt xem:</strong> 32112
							</p>
							<p>
								<strong>Lượt thích:</strong> 23421
							</p>
							<p>
								<strong>Mô tả:</strong> Crayon Shinchan xoay quanh những câu
								chuyện thú vị của một cậu nhóc 5 tuổi tinh quái Nohara
								Shinnosuke với bố Hiroshi và mẹ Misae cùng những người bạn vô
								cùng dễ thương ở trường mẫu giáo. Sự "hiểu đời" rất vô tư của
								nhóc Shin đã gây ra những tình huống dở khóc dở cười cho bao
								người lớn. Tuy nhiên đằng sau tiếng cười đó là những bài học nhẹ
								nhàng về cách nuôi dạy con trẻ khiến chúng ta phải suy ngẫm.
							</p>
							<div class="mt-5">
								<a type="button" class="btn btn-primary btn-lg"
									href="c_comic/shin/doctruyenshin.jsp">Đọc từ đầu</a> <a
									type="button" class="btn btn-primary btn-lg mx-2"
									href="c_comic/shin/doctruyenshin.jsp">Đọc mới nhất</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-2 mt-5">
					...
					<div class="col-lg-12">
						<div class="list-group">
							...
							<div class="row">
								<div class="col-2">
									<img src="../img/Top10mangahaynhat.png" alt="Bootstrap"
										width="42">
								</div>
								<div class="col-10">
